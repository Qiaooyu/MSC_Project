...
def save_modified_dataset(df, selected_features, save_path):
    ...
    df_modified = df[selected_features + ['isphishing']]
    # Save the modified dataset
    df_modified.to_csv(save_path, index=False)


# Load the data
file_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\train.csv'
df = pd.read_csv(file_path)
...
# Selected features
filtered_df = df[selected_features_hybrid + ['isphishing']]

print(selected_features_hybrid)

# Save the filtered DataFrame to a new CSV file
filtered_csv_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\filtered_train.csv'
filtered_df.to_csv(filtered_csv_path, index=False)


valid_file_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\valid.csv'
valid_save_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\filtered_valid.csv'
...
test_file_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\test.csv'
test_save_path = r'D:\Warwick\MSC_Code\dataset-ok\for train\filtered_test.csv'
