...
# Selected features
filtered_df = df[selected_features_hybrid + ['CLASS_LABEL']]

print(selected_features_hybrid)

# Save the filtered DataFrame to a new CSV file
filtered_csv_path = r'D:\Warwick\MSC_Code\newdataset\filtered_train.csv'
filtered_df.to_csv(filtered_csv_path, index=False)


valid_file_path = r'D:\Warwick\MSC_Code\newdataset\valid.csv'
valid_save_path = r'D:\Warwick\MSC_Code\newdataset\filtered_valid.csv'
...
test_file_path = r'D:\Warwick\MSC_Code\newdataset\test.csv'
test_save_path = r'D:\Warwick\MSC_Code\newdataset\filtered_test.csv'
